              ...
              {blogs && blogs.map((post) => (
                <>
                  <article
                    ...
                    className='flex flex-col h-fit bg-white rounded-lg shadow-lg md:flex-row lg:flex-row items-center gap-4 bg-white rounded-lg mb-5 w-full'>
                    <Link href={`/${post._id}`} className='h-full w-full md:w-[50%] lg:w-[50%] xl:w-[50%]'>
                      <Image
                ...
                <aside className='w-full p-6 sm:w-60 h-fit bg-gray-900 text-gray-100 pb-28 rounded-sm'>
                  <nav className='space-y-8 text-sm'>
                    <div className='space-y-9'>
                      <div>
                        <h2 className='text-sm font-semibold tracking-wide uppercase text-gray-400'>Technology</h2>
                        <div className='flex flex-col space-y-2'>
                          ...
                          <Link href='/category/machine-learning'>Machine Learning</Link>
                          <Link href='/category/web-development'>Web Development</Link>
                        </div>
                      </div>

                      <div>
                        <h2 className='text-sm font-semibold tracking-wide uppercase text-gray-400'>Travel</h2>
                        <div className='flex flex-col space-y-2'>
                          <Link href='/category/travel'>Travel</Link>
                          <Link href='/category/adventure-destinations'>Adventure Destinations</Link>
                          <Link href='/category/cultural-experiences'>Cultural Experiences</Link>
                      ...
                      <div>
                        <h2 className='text-sm font-semibold tracking-wide uppercase text-gray-400'>Lifestyle</h2>
                        <div className='flex flex-col space-y-2'>
                      ...
                      <div>
                        <h2 className='text-sm font-semibold tracking-wide uppercase text-gray-400'>Other Categories</h2>
                        <div className='flex flex-col space-y-2'>
                          ...
                          <Link href='/category/technology-gadgets'>Technology Gadgets</Link>
                          <Link href='/category/history'>History</Link>
                          <Link href='/category/travel-guides'>Travel Guides</Link>
                          <Link href='/category/family-parenting'>Family & Parenting</Link>
                          <Link href='/category/career'>Career</Link>
                          <Link href='/category/philosophy'>Philosophy</Link>
                          <Link href='/category/religion-spirituality'>Religion & Spirituality</Link>
                        </div>
                      </div>
                    </div>
                  </nav>
